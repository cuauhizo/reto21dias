<template>
    ...
    <div class="w-full flex justify-center items-center">
      <router-link to="/" class="inline-flex gap-2 rounded-full transition-all mt-2 duration-500  text-xs justify-center items-center bg-gradient-to-r from-[#4D008C] to-[#C028B9] hover:bg-gradient-to-br px-8 py-2">Ir a inicio</router-link>
    </div>
    </section>
</template>