...
<template>
  <section id="section1" class="relative flex items-center justify-center overflow-hidden bg-hero mx-4 md:mx-6 rounded-[32px] md:rounded-[48px] mt-4 md:mt-12 min-h-[auto] py-12 md:py-0 lg:h-[824px]">
      ...
      <div class="container mx-auto">
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-y-12 lg:gap-x-12 items-center">
          <div class="lg:col-span-6 flex flex-col gap-6">
            <div>
              <p class="text-lg font-black font-nexa-bold leading-tight mb-4 text-center md:text-left text-teal-300 md:text-white">21 días que van a cambiar tu vida para bien</p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
              <div v-for="card in infoCards" :key="card.id" class="bg-black/30 rounded-2xl border border-white/25 backdrop-blur-md p-5 hover:bg-black/40 transition-colors duration-300">
